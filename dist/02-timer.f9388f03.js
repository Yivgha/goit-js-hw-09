...
})({"dgFMU":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
let counterId;
let deltaTime;
_flatpickrDefault.default("#datetime-picker", options);
...
function checkValidDate() {
    ...
    if (currentDate > selectedDate) _notiflixNotifyAio.Notify.failure("Please choose a date in the future");
...
function startCountdown(deltaTime1) {
    const formattedTime = convertMs(deltaTime1);
    updateNumbers(formattedTime);
    if (deltaTime1 < 1000) stopCountdown();
}
...
},{}]},["dgFMU","1AWyZ"], "1AWyZ", "parcelRequired7c6")
